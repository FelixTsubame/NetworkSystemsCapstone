...
# docker build -t base .
# docker run -it --cap-add=NET_ADMIN --name H1 --net=none --privileged base
# docker run -it --cap-add=NET_ADMIN --name H2 --net=none --privileged base
# docker run -it --cap-add=NET_ADMIN --name BRG1 --net=none --privileged base
# docker run -it --cap-add=NET_ADMIN --name BRG2 --net=none --privileged base
# docker run -it --cap-add=NET_ADMIN --name R1 --net=none --privileged base
# docker run -it --cap-add=NET_ADMIN --name R2 --net=none --privileged base
# docker run -it --cap-add=NET_ADMIN --name BRGr --net=none --privileged base
...
# Setup Dynamic GRE
#make
docker cp /home/kaorip/a.out BRGr:/tmp/
docker exec BRGr chmod +x /tmp/a.out
